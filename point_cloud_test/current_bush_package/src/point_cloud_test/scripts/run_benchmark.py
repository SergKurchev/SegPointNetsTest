...
def main() -> None:
    ...
    parser.add_argument("--dataset-root", type=Path, default=Path(r".\artifacts\dataset"))
    parser.add_argument("--output-root", type=Path, default=Path(r".\artifacts\benchmark"))
